...
<!--menuresponsive-->
  ...
  <ul id="slide-out" class="side-nav">
    ...
    <li class="thin"><a href="index.php">Inicio</a></li>
       <li class="thin"><a href="menu.php">Menus</a></li>
            ...
            <li class="thin"><a href="#test5">Agregar Menus</a></li>
        ...
        <div class="col s12 m4 l4">
          <div class="card small">
            <div class="card-image">
              ...
              <span class="card-title">Titulo Menu</span>
            </div>
            <div class="card-content">
              <p>Descripcion breve del menu seleccionado.</p>
            </div>
